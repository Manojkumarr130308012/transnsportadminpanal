...
export class DepartmentComponent implements OnInit {
  ...
  editRow(row, rowIndex, content) {
    ...
    this.request.fetchdepartmentById(row._id).subscribe((response) => {
      this.editcustmergroup=response[0];
      console.log("ddddddd",this.editcustmergroup);


      this.IdValue=this.editcustmergroup._id;
      this.Departmentvalue=this.editcustmergroup.Department ; 
  ...
  deleteRecord(row) {
    ...
    this.request.deletedepartment(row._id).subscribe((response) => {
      console.log(response);
      this.viewdata();
     }, (error) => {
       console.log(error);
  ...
  onAddRowSave(form: FormGroup) {
    ...
    this.request.adddepartment(form.value).subscribe((res: any) => {
